...
namespace Products.Infrastructure.Migrations
{
    ...
    [Migration("20250318065724_init-db")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Products.Domain.Products.Models.ProductBrand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Products.Domain.Products.Models.ProductCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 3, 18, 6, 57, 23, 703, DateTimeKind.Utc).AddTicks(4560));
                    ...
                    b.Property<DateTime>("ModificationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 3, 18, 6, 57, 23, 703, DateTimeKind.Utc).AddTicks(5106));
            ...
            modelBuilder.Entity("Products.Domain.Products.Models.ProductEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Products.Domain.Products.Models.ProductCategory", b =>
                {
                    b.HasOne("Products.Domain.Products.Models.ProductCategory", "ParentCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("Products.Domain.Products.Models.ProductEntity", b =>
                {
                    b.HasOne("Products.Domain.Products.Models.ProductBrand", "ProductBrand")
                        .WithMany("Products")
                        .HasForeignKey("BrandId");

                    b.HasOne("Products.Domain.Products.Models.ProductCategory", "Category")
                        .WithMany("Products")
